    ...
    <div className="flex justify-center">
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          />
          {errors.username && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-sm text-red-700">{errors.username}</div>
          )}
          <Input
            label="密码"
            type="password"
          ...
          />
          {errors.password && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-sm text-red-700">{errors.password}</div>
          )}
          <Input
            label="确认密码"
            type="password"
          ...
          />
          {errors.password2 && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-sm text-red-700">{errors.password2}</div>
          )}
          {errors.general && (
