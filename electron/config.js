...
module.exports = {
  ...
  DJANGO_URL: process.env.OPENSHSID_DJANGO_URL || 'http://openshsid.zengyuxiang.cn:19424',
  // Flask 模型服务（/rei、/click、/translate）
  FLASK_URL: process.env.OPENSHSID_FLASK_URL || 'http://openshsid.zengyuxiang.cn:5000',
  // 生产模式下本地静态+代理服务器监听端口
